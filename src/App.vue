...
const subViews = {
  ...
  // `parkFilter: false`: парк — ЛОКАЛЬНЫЙ чип-фильтр раздела по трём СПб-паркам
  // (§0.1 п.2/п.4: «Вся сеть» = 3 СПб, MARI исключён), а не глобальная пилюля,
  // которая включает MARI и трактует сеть как все парки приложения.
  drivers: {
