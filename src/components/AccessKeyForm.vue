    ...
    <div class="flex flex-1 items-start justify-center pt-[13svh]">
      ...
      >
        ...
        <!-- Бейдж уровня продукта (D-23, 19.08.2026). Третий ярус лочкапа, а не
             ...
             UI-шкалы: кегль 14px = ровно половина слова (28px), зазор 12px —
             тот же шаг, что шеврон→слово, высота 22px = cap-height 10.1px плюс
             по 6px полей.
             ...
             pt-[1px] — оптический центр: капс без выносных элементов при
             геометрическом центрировании читается смещённым вверх (тот же приём,
             что pt-[2px] у кнопки СТАРТ). mr компенсирует трекинг после
             последней буквы, как у слова выше.
        ...
        <span
          ...
          class="mt-[12px] flex h-[22px] items-center justify-center border-[1.5px] border-[var(--text)] px-[12px] pt-[1px] font-brand text-[0.875rem] uppercase leading-none tracking-[0.16em] text-[var(--text)] md:mt-[18px] md:h-[33px] md:border-2 md:px-[18px] md:text-[1.3125rem]"
          aria-hidden="true"
        ><span class="mr-[-0.16em]">Ультра</span></span>
      </div>
    </div>
