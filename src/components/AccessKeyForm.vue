    ...
    <div class="flex flex-1 items-start justify-center pt-[13svh]">
      ...
      >
        ...
        <span
          ...
          class="mt-0 flex h-[27px] items-center justify-center border-[1.5px] border-[var(--text)] px-[15px] pt-[1px] font-brand text-[1.09375rem] uppercase leading-none tracking-[0.16em] text-[var(--text)] md:h-[32px] md:border-2 md:px-[18px] md:text-[1.3125rem]"
          aria-hidden="true"
