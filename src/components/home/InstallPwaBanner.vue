...
// Баннер «Откройте Мастерплан как приложение» на Главной (ревизия 12.06.2026).
...
const steps = [
  ...
  'Нажмите «Добавить» — иконка Мастерплана появится рядом с другими приложениями.',
]
</script>
    ...
    >
      ...
      <div class="flex min-w-0 flex-1 flex-col gap-1 pr-8">
        <span class="text-[0.9375rem] font-semibold leading-[1.15] text-[var(--text)]">
          Откройте Мастерплан<br />как приложение
        </span>
        <button
          type="button"
    ...
    >
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4">
          ...
          >Добавьте Мастерплан на домашний экран</h3>
