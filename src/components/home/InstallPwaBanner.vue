...
// Баннер «Откройте Ранскеил как приложение» на Главной (ревизия 12.06.2026;
// имя продукта 28.07.2026: «Мастерплан» → «Ранскейл», D-20 — «Мастерплан» стал
// внутренним именем модуля, продукт называется Ранскеил. Иконка НЕ менялась —
// это отдельная задача владельца).
//
// D-23 (19.08.2026): написание через «и» — Ранскеил. ИМЯ СТОИТ ТОЛЬКО В
// ИМЕНИТЕЛЬНОМ (решение владельца): «Ранскеила»/«Ранскеилом» выглядят опечаткой,
// поэтому фразы переписаны так, чтобы падеж брала на себя соседняя опора
// («иконка Ранскеил», «Ранскеил на айфоне»), а не само имя. Правило действует на
// весь фронт — при новых текстах склонять имя нельзя.
...
const steps = [
  ...
  'Нажмите «Добавить» — иконка Ранскеил появится рядом с другими приложениями.',
]
</script>
    ...
    >
      ...
      <div class="flex min-w-0 flex-1 flex-col gap-1 pr-8">
        <span class="text-[0.9375rem] font-semibold leading-[1.15] text-[var(--text)]">
          Откройте Ранскеил<br />как приложение
        </span>
        <button
          type="button"
    ...
    >
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4">
          ...
          >Добавьте Ранскеил на домашний экран</h3>
