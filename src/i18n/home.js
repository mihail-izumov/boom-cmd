...
export const L = {
  ...
  checkups: 'Чекапов',
  signals: 'Сигналов',
  // 05.08: до этого дня Главная молчала о неудачной загрузке — `useDaily` писал
  // причину в `error`, а экран его не читал. «Данных нет» и «запрос не дошёл»
  // выглядели одинаково: везде прочерки. Ровно та молчаливая деградация, из-за
  // которой владелец полчаса искал поломку там, где её не было.
  load_error: 'Данные не загрузились',
