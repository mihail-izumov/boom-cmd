...
export const L = {
  ...
  //
  // ⚠ Формулировка — дословно от владельца (15.08) и она РАСХОДИТСЯ с правилом
  // безличной формы выше: «Прочитал» — мужской род, а управляющие в основном
  // женщины. Оставлено как сказано, но расхождение названо владельцу; безличные
  // варианты того же смысла — «Отметить и оценить», «Прочитано и оценка».
  signal_read_rate: 'Прочитал и оценить',
  // Выход из шкалы, при котором прочтение всё равно записывается. Отметка не должна
  // становиться заложником оценки — это ровно тот регресс, которым разделение кнопок
  // и оправдывалось.
  signal_rate_skip: 'Отметить без оценки',
